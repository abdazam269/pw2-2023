            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <h2 class="text-center">Daftar Dokter</h2> -->
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="telpon" class="col-4 col-form-label">Nomer telepon</label>
                                    <div class="col-8">
                                        <input id="telpon" name="telpon" type="text" inputmode="numeric" pattern="[0-9]*" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
